            ...
            <el-table :data="deptList" row-key="_id" :tree-props="{children:'children'}" stripe>
                ...
                <el-table-column label="操作">
                    <template #default="scope">
                        ...
                        <el-button size="mini" type="primary" @click="handleDel(scope.row._id)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
        ...
        <el-dialog :title="action == 'create' ? '创建部门' : '编辑部门' " v-model="showModal">
            <el-form ref="dialogForm" :model="deptForm" :rules="rules" label-width="120px">
                ...
                <el-form-item label="负责人邮箱" prop="userEmail">
                    <el-input placeholder="请输入负责人邮箱" disabled v-model="deptForm.userEmail"/>
                </el-form-item>
            </el-form>
            <template #footer>
